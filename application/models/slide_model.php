...
class Slide_model extends CI_Model {
	...
	function get_exchangerate(){
		...
		$this->db->join('country', 'exchange_rate.CountryId = country.CountryId', 'exchange_rate.Status = 1');
		$this->db->limit(9);
		$this->db->order_by("ExchangeRateDate", "desc");
    	return $this->db->get()->result();
